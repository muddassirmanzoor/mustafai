...
if ($_POST){
	...
	$Result = mysqli_query($mysqli, "SELECT * FROM users WHERE mobileno=$mobileno");
	if (mysqli_num_rows($Result)==0){
	    echo "Add";
	    $sql = "INSERT INTO users (name, emailaddress, mobileno, fathername, phouseno, pstreetno, parea, punit, ptehsil, pdistrict, pprovince, thouseno, tstreetno, tarea, tunit, ttehsil, tdistrict, tprovince, profession, whatsappno)
                VALUES ('$name', '$emailaddress', '$mobileno', '$fathername', '$phouseno', '$pstreetno', '$parea', '$punit', '$ptehsil', '$pdistrict', '$pprovince' , '$thouseno', '$tstreetno', '$tarea', '$tunit', '$ttehsil', '$tdistrict', '$tprovince', '$profession', '$whatsappno')";
...
<body>
    <div class="wrapper">
                <form name="form1" method="post" action="add.php" id="wizard">
            <!-- SECTION 1 -->
            <h4></h4>
            <section>
                <div class="inner">
                    ...
                    <div class="form-row form-group">
                        ...
                        <div class="form-holder">
                            <input type="text" class="form-control" name="mobileno" placeholder="Phone No"
