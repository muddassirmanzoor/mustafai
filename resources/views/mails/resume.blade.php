                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align: right; width: 50%;margin-left:auto;">
                            <h2 style="display: inline-block; vertical-align: top"><span>{{auth()->user()->user_name}}</span><br /><span style="font-weight: 400; font-size: 14px;">{{ auth()->user()->address_english ?? __('app.your-tagline-here') }}</span></h2>
                            <br>
