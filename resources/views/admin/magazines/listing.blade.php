                        ...
                        <div class="card">
                            <div class="card-header">
                                @if (have_right('Create-Magazines'))
                                    <h3 class="card-title">
                                        <a href="{{ URL('admin/magazines/create') }}" class="btn btn-primary"> Add New </a>
                                    </h3>
                                @endif
                            </div>
                            <div class="card-body">
    ...
    <script>
        $(function() {
            $('#pages-datatable').dataTable({
                ...
                responsive: true,
                dom: 'Blfrtip',
                buttons: dataCustomizetbaleAdmin("Magazines", arrywidth = ['25%', '25%', '25%','25%'],
                    arraycolumn = [0, 1, 2,4]),
                lengthMenu: [
                ...
                columns: [{
                    ...
                    {
                        data: 'magzine_category',
                        name: 'magzine_category'
                    },
                    {
                        data: 'status',
                        name: 'status'
