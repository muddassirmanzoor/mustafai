	...
	<div class="content-wrapper">
		...
		<div class="content-header">
		  <div class="container-fluid">
		    <div class="row mb-2">
		      <div class="col-sm-6">
		        <h1 class="m-0">Add Menifesto</h1>
		      </div><!-- /.col -->
		      <div class="col-sm-6">
		        <ol class="breadcrumb float-sm-right">
		          <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
		          <li class="breadcrumb-item"><a href="{{ URL('admin/ceomessage') }}">Menifesto</a></li>
		          <li class="breadcrumb-item active">Add Menifesto</li>
		        </ol>
		      </div><!-- /.col -->
		    </div><!-- /.row -->
		  </div><!-- /.container-fluid -->
		          	...
		          	<div class="col-md-12">
			            ...
			            <div class="card card-primary">
			              <div class="card-header">
			                <h3 class="card-title">Menifesto Form</h3>
			              </div>
													...
													<div class="col-sm-2">
														...
														@else
															<a href="javascrit:void(0)" target="_blank">
															 	<img id="sample_image" src="{{ asset('https://www.freeiconspng.com/uploads/no-image-icon-6.png') }}" alt="your image" width="60" height="60" />
															</a>
															{{-- <button class="btn btn-sm btn-danger d-block mt-2" id="clear_image" > clear Image</button> --}}
													  	@endif
													</div>
													...
													<div class="col-sm-4">
														<div class="form-group ">
															<label class="form-label">Message ({{ $lang->name_english }}) <span class="text-red">*</span></label>
																<textarea id="summernote"  class="summernote " name="message_{{ $lang->key }}" required>{{$row->{'message_'.$lang->key} }}</textarea>
														</div>
													</div>
                                                    @endforeach
												</div>
