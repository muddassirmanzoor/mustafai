...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Create Magazine Category</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
                        <li class="breadcrumb-item"><a href="{{ URL('admin/categories') }}">Magazine Categories</a></li>
                        <li class="breadcrumb-item active">Create Magazine Category</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Magazine Category Form</h3>
                        </div>

                        <!-- /.card-header -->
                        <div class="card-body">
                            <form id="magazine-categories-form" class="form-horizontal label-left" action="{{ URL('admin/magazine-categories') }}" enctype="multipart/form-data" method="POST">
                                {!! csrf_field() !!}
                                ...
                                <div class="card-body">
                                    <div class="form-group text-right">
                                        <div class="col-sm-12">
                                            <a href="{{ URL('admin/magazine-categories') }}" class="btn btn-info" style="margin-right:05px;"> Cancel </a>
...
<script>
    $(function() {
        $('#magazine-categories-form').validate({
            ignore: false
            , rules: {}
            , errorElement: 'span'
