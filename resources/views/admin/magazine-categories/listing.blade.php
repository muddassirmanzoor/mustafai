...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Magazine Categories</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
                        <li class="breadcrumb-item active">Magazine Categories</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
...
<script>
    $(function() {
        $('#categories-datatable').dataTable({
            ...
            , responsive: true
            , dom: 'Blfrtip'
            , buttons: dataCustomizetbaleAdmin("Magazine Categories", arrywidth = ['30%', '70%']
                , arraycolumn = [0, 1])
            , lengthMenu: [
            ...
            , serverSide: true
            , ajax: "{{ url('admin/magazine-categories') }}"
            , columns: [{
                    data: 'DT_RowIndex'
                    , name: 'DT_RowIndex'
                    , orderable: false
