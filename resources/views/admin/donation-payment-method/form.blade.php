	...
	<div class="content-wrapper">
		...
		<div class="content-header">
		  <div class="container-fluid">
		    <div class="row mb-2">
		      <div class="col-sm-6">
		        <h1 class="m-0">Add Donation Payment Method</h1>
		      </div><!-- /.col -->
		      <div class="col-sm-6">
		        <ol class="breadcrumb float-sm-right">
		          <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
		          <li class="breadcrumb-item"><a href="{{ URL('admin/donation-payment-method') }}">Donation Payment Method</a></li>
		          <li class="breadcrumb-item active">Add Donation Payment Method</li>
		        </ol>
		      </div><!-- /.col -->
		    </div><!-- /.row -->
		  </div><!-- /.container-fluid -->
		          	...
		          	<div class="col-md-12">
			            ...
			            <div class="card card-primary">
			              <div class="card-header">
			                <h3 class="card-title">Donation Payment Form</h3>
			              </div>

			              <!-- /.card-header -->
			              <div class="card-body">
			                <form id="donate-now-form" class="form-horizontal label-left" action="{{ URL('admin/donation-payment-method') }}" enctype="multipart/form-data" method="POST">
			                	{!! csrf_field() !!}
								...
								<div class="card-header">
									...
									<div class=" dynamic_row row" id="dynamic_row">

										@if($action == 'edit')

											@foreach($donationPaymentMethod as $key=>$valDonationPayment)
												{{-- <div class="row"> --}}
													<div class="col-md-6 mb-xxl-3 mb-1  common_div">
														{{-- <h6>{{$val->account_title}}</h6> --}}
														<label for="">Mustafai Account Title:</label>
														<input type="text" class="form-control" name="account_ttile[{{$valDonationPayment->id}}]" value="{{$valDonationPayment->account_title}}" />
													</div>
												{{-- </div> --}}
												{{-- {{dd($val->donationPaymentMethodDetails())}} --}}
												@foreach($valDonationPayment->donationPaymentMethodDetails as $keyDetails=>$valDonationMethodDetails)
												{{-- <div class="row"> --}}

													 <div class="col-md-6 mb-xxl-3 mb-1  common_div" style="" >
												...
												{{-- </div> --}}
												@endforeach
												<div class="col-md-12 d-flex justify-content-end align-items-end ml-auto">
													<span  onclick="deleteProductPayment({{$valDonationPayment->id}},$(this))"  class = "btn btn-sm btn-danger">Remove</span>
												</div>
											@endforeach
										@endif
			                	...
			                	<div class="card-body">
				                  	<div class="form-group text-right">
				                  		<div class="col-sm-12">
				                  			<a href="{{ URL('admin/donation-payment-method') }}" class="btn btn-info" style="margin-right:05px;"> Cancel </a>
  ...
  <!-- jQuery -->
	...
	<script>
		...
		function deleteProductPayment(id,_this)
		{
			...
			$.ajax({
				type: "get",
				url: "{{route('admin.delete-donation-payment')}}",
				data:{id:id},
