...
@push('header-scripts')
  ...
  <style>
    div#announcements-datatable_length {
    padding-top: 24px;
    }
    div#announcements-datatable_filter {
    margin-top: -41px;
    }
</style>
@endpush
				    ...
				    <div class="card">
				      <div class="card-header">
				      	@if(have_right('add-announcement'))
					        <h3 class="card-title">
					        	<a href="{{ URL('admin/announcements/create') }}" class="btn btn-primary"> Add New </a>
					        </h3>
				        @endif
				      </div>
				      <div class="card-body">
				        <table id="announcements-datatable" class="table table-bordered table-striped" style="width:100%">
				          <thead>
				              <tr>
				                <th>ID</th>
				                <th>Title English</th>
	    ...
	    $('#announcements-datatable').dataTable(
      	{
            ...
            buttons: [
                        {
                            extend: 'pdf',
                            text: '<i class="fa fa-file-pdf-o" aria-hidden="true" title="Announcements"></i>&nbsp;Export as PDF',
                            title: 'Announcements',
