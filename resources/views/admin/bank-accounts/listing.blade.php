				    ...
				    <div class="card">
				      <div class="card-header">
				      	@if(have_right('Create-Bank'))
					        <h3 class="card-title">
					        	<a href="{{ URL('admin/bank-accounts/create') }}" class="btn btn-primary"> Add New </a>
					        </h3>
				        @endif
				      </div>
				      <div class="card-body">
	    ...
	    $('#categories-datatable').dataTable(
      	{
			...
			responsive: true,
			dom: 'Blfrtip',
            buttons: dataCustomizetbaleAdmin("Categories",  arrywidth= [ '25%', '25%','25%','25%'],  arraycolumn = [0,1,2,3]),
			lengthMenu: [[5, 10, 25, 50, 100, 200, -1], [5, 10, 25, 50, 100, 200, "All"]],
			serverSide: true,
			ajax: "{{ url('admin/bank-accounts') }}",
			columns: [
				{data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false, searchable: false},
				{data: 'account_title_english', name: 'account_title_english'},
