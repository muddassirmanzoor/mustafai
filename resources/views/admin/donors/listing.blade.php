				    ...
				    <div class="card">
				      <div class="card-header">
				      	@if(have_right('Create-Blood-Donors'))
					        <h3 class="card-title">
					        	<a href="{{ URL('admin/donors/create') }}" class="btn btn-primary"> Add New </a>
					        </h3>
				        @endif
				      </div>
				      <div class="card-body">
	    ...
	    $('#pages-datatable').dataTable(
      	{
			...
			responsive: true,
			dom: 'Blfrtip',
            buttons: dataCustomizetbaleAdmin("Blood Donors",  arrywidth= [ '8%', '26%', '10%','22%','22%','10%'],  arraycolumn = [0,1,2,3,4,6]),
