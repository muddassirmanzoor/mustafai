...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Create Office Address</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
                        <li class="breadcrumb-item"><a href="{{ URL('admin/office-addresses') }}">Addresses</a></li>
                        <li class="breadcrumb-item active">Create Office Address</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Office Address Form</h3>
                        </div>

                        <!-- /.card-header -->
                        <div class="card-body">
                            <form id="categories-form" class="form-horizontal label-left" action="{{ URL('admin/office-addresses') }}" enctype="multipart/form-data" method="POST">
                                {!! csrf_field() !!}
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group ">
                                                            <label class="form-label">Office Address ({{ $lang->name_english }}) <span class="text-red">*</span></label>
                                                            <input type="text" class="form-control" placeholder="Enter Office Address {{ $lang->name_english }}" name="address_{{ $lang->key }}" value="{{ $row->{'address_'.$lang->key} }}" required="">
                                                        </div>
                                                    </div>
                                                    @endforeach
                                                </div>
                                        ...
                                        <div id="link" class="collapse" aria-labelledby="message-title-heading" data-parent="#accordionExample">
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <div class="form-group ">
                                                            <label class="form-label">Office Address Link <span class="text-red">*</span></label>
                                                            <input type="text" class="form-control" placeholder="Enter Office Address Link" name="address_link" value="{{ $row->address_link }}" required="">
                                                        </div>
                                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="form-group text-right">
                                        <div class="col-sm-12">
                                            <a href="{{ URL('admin/office-addresses') }}" class="btn btn-info" style="margin-right:05px;"> Cancel </a>
