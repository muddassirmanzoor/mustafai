	...
	<div class="content-wrapper">
		...
		<div class="content-header">
		  <div class="container-fluid">
		    <div class="row mb-2">
		      <div class="col-sm-6">
		        <h1 class="m-0">Product Payment Methods</h1>
		      </div><!-- /.col -->
		      <div class="col-sm-6">
		        <ol class="breadcrumb float-sm-right">
		          <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
		          <li class="breadcrumb-item active">Product Payment Methods</li>
		        </ol>
		      </div><!-- /.col -->
		    </div><!-- /.row -->
		  </div><!-- /.container-fluid -->
				    ...
				    <div class="card">
				      <div class="card-header">
				      	@if(have_right('Create-Product-Payment-Method'))
					        <h3 class="card-title">
					        	<a href="{{ URL('admin/product-payment-method/create') }}" class="btn btn-primary"> Add New</a>
					        </h3>
				        @endif
				      </div>
				      <div class="card-body">
	    ...
	    $('#pages-datatable').dataTable(
      	{
			...
			responsive: true,
			dom: 'Blfrtip',
            buttons: dataCustomizetbaleAdmin("Product Payment Methods",  arrywidth= [ '33%', '33%', '33%'],  arraycolumn = [0,1,3]),
			lengthMenu: [[5, 10, 25, 50, 100, 200, -1], [5, 10, 25, 50, 100, 200, "All"]],
			serverSide: true,
			ajax: "{{ url('admin/product-payment-method') }}",
			columns: [
