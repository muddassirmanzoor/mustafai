	    ...
	    $('#pages-datatable').dataTable(
      	{
			...
			responsive: true,
			dom: 'Blfrtip',
            buttons: dataCustomizetbaleAdmin("Ceo Message",  arrywidth= ['10%', '80%', '10%'],  arraycolumn = [0,1,3]),
			lengthMenu: [[5, 10, 25, 50, 100, 200, -1], [5, 10, 25, 50, 100, 200, "All"]],
			serverSide: true,
			ajax: "{{ url('admin/book-receipts-log') }}?id="+id+"",
			columns: [
