	...
	<div class="content-wrapper">
		...
		<div class="content-header">
		  <div class="container-fluid">
		    <div class="row mb-2">
		      <div class="col-sm-6">
		        <h1 class="m-0">Add Our Team Section</h1>
		      </div><!-- /.col -->
		      <div class="col-sm-6">
		        <ol class="breadcrumb float-sm-right">
		          <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
		          <li class="breadcrumb-item"><a href="{{ URL('admin/sections') }}">Add Our Team Section</a></li>
		          <li class="breadcrumb-item active">Add Our Team Section</li>
		        </ol>
		      </div><!-- /.col -->
		    </div><!-- /.row -->
		  </div><!-- /.container-fluid -->
		          	...
		          	<div class="col-md-12">
			            ...
			            <div class="card card-primary">
			              <div class="card-header">
			                <h3 class="card-title">Our Team Section</h3>
			              </div>

			              <!-- /.card-header -->
			              <div class="card-body">
			                <form id="page-form" class="form-horizontal label-left" action="{{ URL('admin/sections') }}" enctype="multipart/form-data" method="POST">
			                	{!! csrf_field() !!}
										...
										<div class="card-body">
												...
												<div class=" col-sm-4 ">
													<div class="form-group ">
														...
														<textarea class="form-control ml-2" name="content_{{ $lang->key }}" placeholder="Enter Content In {{ $lang->name_english }}" required="">{{$row->{'content_'.$lang->key} }}</textarea>
													</div>
												</div>
												@endforeach
												</div>
			                	...
			                	<div class="card-body">
				                  	<div class="form-group text-right">
				                  		<div class="col-sm-12">
				                  			<a href="{{ URL('admin/sections') }}" class="btn btn-info" style="margin-right:05px;"> Cancel </a>
