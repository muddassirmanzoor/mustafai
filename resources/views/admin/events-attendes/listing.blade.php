	...
	<div class="content-wrapper">
		...
		<div class="content-header">
		  <div class="container-fluid">
		    <div class="row mb-2">
		      <div class="col-sm-6">
		        <h1 class="m-0">Event Attendees</h1>
		      </div><!-- /.col -->
		      <div class="col-sm-6">
		        <ol class="breadcrumb float-sm-right">
		          <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
		          <li class="breadcrumb-item"><a href="{{ url('admin/events') }}">Events</a></li>
		          <li class="breadcrumb-item active">Events Attendees</li>
		        </ol>
		      </div><!-- /.col -->
		    </div><!-- /.row -->
		  </div><!-- /.container-fluid -->
	    ...
	    $('#events-datatable').dataTable(
      	{
			...
			responsive: true,
			dom: 'Blfrtip',
			buttons: dataCustomizetbaleAdmin("Event Attendes",  arrywidth= [ '33%','33%','33%'],  arraycolumn = [0,1,2]),
			lengthMenu: [[5, 10, 25, 50, 100, 200, -1], [5, 10, 25, 50, 100, 200, "All"]],
			serverSide: true,
			ajax: "{{ route('event.attendes',[$id]) }}",
			columns: [
				{data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false, searchable: false},
				{data: 'event', name: 'event'},
				{data: 'attende_email', name: 'attende_email'},
