				    ...
				    <div class="card">
				      <div class="card-header">
				      	@if(have_right('Create-Bank'))
					        <h3 class="card-title">
					        	<a href="{{ URL('admin/banks/create') }}" class="btn btn-primary"> Add New </a>
					        </h3>
				        @endif
				      </div>
				      <div class="card-body">
	    ...
	    $('#categories-datatable').dataTable(
      	{
			...
			responsive: true,
			dom: 'Blfrtip',
            buttons: dataCustomizetbaleAdmin("Categories",  arrywidth= [ '30%', '70%'],  arraycolumn = [0,1]),
			lengthMenu: [[5, 10, 25, 50, 100, 200, -1], [5, 10, 25, 50, 100, 200, "All"]],
			serverSide: true,
			ajax: "{{ url('admin/banks') }}",
			columns: [
