				...
				<div class="row">
		          	<div class="col-md-12">
			            ...
			            <div class="card card-primary">
			              ...
			              <!-- /.card-header -->
			              <div class="card-body">
			                <form id="page-form" class="form-horizontal label-left" action="{{ URL('admin/vendors') }}" enctype="multipart/form-data" method="POST">
			                	{!! csrf_field() !!}
                                                    ...
                                                    @foreach (activeLangs() as $lang)
                                                        <div class="col-sm-4">
                                                            <div class="form-group ">
                                                                <label class="form-label"> Vendor Name ({{ $lang->name_english }})<span class="text-red">*</span></label>
			                	...
			                	<div class="card-body">
				                  	<div class="form-group text-right">
				                  		<div class="col-sm-12">
				                  			<a href="{{ URL('admin/vendors') }}" class="btn btn-info" style="margin-right:05px;"> Cancel </a>
