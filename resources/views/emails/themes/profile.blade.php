                    ...
                    @if ($user->id == auth()->user()->id)
                        ...
                        <p>
                            @php
                                ...
                                {
                                    $role = \App\Models\Admin\Role::where('id', auth()->user()->login_role_id)->first();
                                    $cabinetUser = \App\Models\Admin\CabinetUser::where('role_id', auth()->user()->login_role_id)->where('user_id',auth()->user()->id)->first();
                                }
                            @endphp
