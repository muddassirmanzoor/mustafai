...
<div class="lib-data-dynamically col-xxl-3 col-xl-4 col-sm-6 mb-xl-0 mb-3 mt-3">
    @if(isset($empId))
...
@else
<div class="col-lg-12  mb-lg-0 mb-3 mt-lg-3 d-flex justify-content-center align-items-center">
